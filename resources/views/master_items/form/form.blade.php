<form method="POST" enctype="multipart/form-data">
    ...
    @php $selected = $item->categories ?? ''; @endphp
    <div class="form-group">
        ...
        <select name="categories[]" class="form-control" required>
            ...
            @foreach ($categories as $cat)
                @php
                    $selected = false;
                    if ($method == 'edit' && $item->categories && $item->categories->contains($cat->id)) {
                        $selected = true;
                    } elseif ($method == 'new' && $cat->nama == 'Umum') {
                        $selected = true;
                    }
                @endphp
    ...
    <div class="form-group">
        ...
        @if (!empty($item->foto))
            <img src="{{ asset('storage/foto_items/' . $item->foto) }}" alt="Foto Item" class="img-thumbnail mt-2"
